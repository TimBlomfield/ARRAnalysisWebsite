  ...
  return (
    <section className={styles.main}>
      <article className={styles.full}>
        ...
        <p>Navigate to the <strong>User Licenses</strong> page. The example below shows a license assigned to the <strong>User</strong> <strong className={styles.more}>riggs.clarke@example.com</strong> by the <strong>Customer</strong> <strong className={styles.more}>kara.newman@example.com</strong>:</p>
