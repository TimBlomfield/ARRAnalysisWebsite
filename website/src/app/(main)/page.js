    ...
    <main className={styles.main}>
      ...
      <section className={styles.s2}>
        ...
        <div className={cn(styles.part, styles.right)}>
          <Image alt="ARR Waterfall" src={imgArrWtfl} className={styles.img} />
        </div>
      </section>
      ...
      <section className={styles.s3}>
        ...
        <article className={cn(styles.article, styles.f2)}>
      ...
      <section className={styles.s4}>
        <Image alt="Quarterly and Cohort" src={imgQuart} className={styles.img} priority />
      </section>
    </main>
  );
};
